...
import { DiamondCutFacet, DiamondLoupeFacet, MintBurnFacet, OwnershipFacet, Test1Facet, TheiaCoinFacet } from "../build/typechain"
...
describe('DiamondTest', async function () {
  ...
  let theiaCoinFacet:TheiaCoinFacet
  ...
  before(async function () {
    ...
    theiaCoinFacet = await ethers.getContractAt('TheiaCoinFacet', diamondAddress)
  ...
  it('facets should have the right function selectors -- call to facetFunctionSelectors function', async () => {
    ...
    assert.sameMembers(result, selectors)
    selectors = getSelectors(theiaCoinFacet)
  ...
  it('should theiacoin function call', async () => {
    await mintBurnFacet.mint(accounts[0].address, ethers.utils.parseEther("2000"));
    const balance = await theiaCoinFacet.balanceOf(accounts[0].address)
  ...
  it('add most functions and facets', async () => {
    ...
    const cut = [
      ...
      },
      {
        ...
        action: FacetCutAction.Add,
        functionSelectors: getSelectors(theiaCoinFacet)
      },
      {
    ...
    assert.sameMembers(facets[findAddressPositionInFacets(addresses[3], facets)][1], getSelectors(theiaCoinFacet))
